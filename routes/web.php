...
Route::get('/dashboard/table/sale', [DashboardController::class, 'table']);

Route::get('/dashboard/table/rent', [DashboardController::class, 'forrent']);

Route::get('/dashboard/table/sold', [DashboardController::class, 'sold']);

Route::get('/dashboard/table/rented', [DashboardController::class, 'rented']);

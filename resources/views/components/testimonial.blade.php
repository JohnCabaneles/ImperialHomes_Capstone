 <!-- ######################################### Testimonials ############################################# -->
  ...
  <section class="w-full h-350 my-20 bg-fixed bg-cover bg-center" 
          ...
          <div class="swiper-slide">
            <div>
              <div class="block rounded-lg shadow-lg bg-white">
                ...
                <div class="w-24 -mt-12 overflow-hidden border border-white rounded-full mx-auto bg-white">
              ...
              <div class="block rounded-lg shadow-lg bg-white">
                ...
                <div class="p-6">
                  ...
                  <p class="mt-4 text-center">
                    ...
                    "Working with ImperialHomes was an absolute pleasure. She was extremely knowledgeable about the local real estate market  She was extremely knowledgeable about the local real and provided valuable insights throughout the process. She was always available to answer any questions I had and helped me find the perfect home for me and my family. I highly recommend her services to anyone looking to buy or sell real estate." 
                  </p>
                </div>
              </div>
            </div>

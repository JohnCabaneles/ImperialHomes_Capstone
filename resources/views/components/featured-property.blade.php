...
<div class="container my-24 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-800 text-left">
    ...
    <div class="grid lg:grid-cols-3 gap-3 xl:gap-x-4">
      <div class="mb-6 lg:mb-0 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-10 duration-300">
      ...
      <div class="mb-0 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-10 duration-300">
        <div class="relative block bg-white rounded-lg shadow-lg h-full">
          <div class="flex">
            <div
              class="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-lg mx-4 -mt-4"

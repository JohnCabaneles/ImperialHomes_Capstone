          ...
          <table class="min-w-full bg-white">
            ...
            <tbody class="text-gray-700">
              <tr>
                ...
                <td class="w-1/3 text-left py-3 px-4 border-b border-grey-light"> {{ $listing->location }}</td>
                <td class="w-1/3 text-left py-3 px-4 border-b border-grey-light"> {{ $listing->model }}</td>

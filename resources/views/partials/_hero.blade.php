 ...
 <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
   ...
   <div class="flex justify-center items-center h-full">
     <div class="text-center text-white px-6 md:px-12">
       <h1 class="title text-5xl font-bold mt-0 mb-6"><span class="text-amber-500">IMPERIAL</span>HOMES</h1>
       <h3 class="title2 text-2xl font-light mb-8">“The magic thing about home is that it feels good to leave, and it feels even better to come back.”</h3>
